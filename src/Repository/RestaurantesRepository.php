 ...
 *
 * @implements PasswordUpgraderInterface<Restaurantes>
 *
 ...
 */
class RestaurantesRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    {
        if (!$user instanceof Restaurantes) {
